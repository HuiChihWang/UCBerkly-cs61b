...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object Obj) {
        ...
        SimpleOomage ObjCast = (SimpleOomage) Obj;
        return this.red==ObjCast.red && this.green==ObjCast.green && this.blue==ObjCast.blue;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return 53*53*(red/5) + 53*(green/5) + (blue/5) + 1 ;
        }
    }
